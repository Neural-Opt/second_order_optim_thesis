...
\PassOptionsToPackage{T1}{fontenc} % T2A for cyrillics
  ...
  \usepackage{pgfplots} % Import pgfplots which includes TikZ
  \usepackage{tikz}  
  \usepgfplotslibrary{groupplots}
  % Import TikZ package
  \pgfplotsset{compat=newest} % Set pgfplots compatibility version
...
% ****************************************************************************************************
\newcommand{\myTitle}{Second order methods for neural networks optimization \xspace}
\newcommand{\mySubtitle}{An Homage to The Elements of Typographic Style\xspace}
\newcommand{\myDegree}{Doktor-Ingenieur (Dr.-Ing.)\xspace}
\newcommand{\myName}{Jan Niclas Hardtke\xspace}
...
\newcommand{\myTime}{October 2024\xspace}
...
\newcommand{\JH}[1]{{\color{tabBlue} { (JH: #1)}}}
\newcommand{\MW}[1]{{\color{tabGreen} { (MW: #1)}}}
\newcommand{\comment}[1]{}
